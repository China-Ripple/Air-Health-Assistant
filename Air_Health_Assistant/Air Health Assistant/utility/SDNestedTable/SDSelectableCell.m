...
- (void) styleEnabled
{
    ...
    checkBox.alpha = 1.0;
    itemText.alpha = 1.0;
    self.backgroundView.backgroundColor = [UIColor colorWithRed:8/255 green:30/255 blue:50/255 alpha:1.0];
}
...
- (void) styleHalfEnabled
{
    ...
    checkBox.alpha = 0.45;
    itemText.alpha = 0.7;
    self.backgroundView.backgroundColor = [UIColor colorWithRed:5/255 green:18/255 blue:31/255 alpha:1.0];
}
